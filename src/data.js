export const journey = [
    ...
    {
        header: 'BE in Computer Science and Engineering',
        footer: 'Acharya Institute of Technology',
        timeline: 'June 2025',
        type: 'graduation',
        period: 'December 2021 - June 2025',
        summary: 'I completed my Bachelor\'s in Computer Science and Engineering with a distinction, demonstrating software development expertise through modules in programming, data structures, algorithms and databases, while participating in conferences and events with IEEE. This technical preparation and teamwork experience have equipped me to pursue diverse roles across the IT industry.'
    },
    {
        header: 'Software Developer Intern',
        footer: 'GE Healthcare Private Ltd.',
        timeline: 'January 2025',
        type: 'work',
        period: 'January 2025 - Present',
        summary: 'Built an internal PaaS platform integrating Confluence, Box, and a LangChain chatbot to centralize documentation, enhance search with feedback-based ranking, gaining valuable industry knowledge and software development best practices through close collaboration with mentor and product owners. Focused on improving skills and understanding of the full stack development landscape by working closely with the assigned mentor.'
    },

    {
        header: 'Open-Source Developer',
        footer: 'Python Software Foundation',
        timeline: 'January 2024',
        type: 'work',
        period: 'January 2024 - March 2024',
        summary: 'Improved SymPy’s documentation by fixing 55+ broken links, refactoring for Sphinx compliance, and enhancing the Symbol class docstring—reducing CI warnings by 40%—while collaborating with project maintainers for valuable insights.'
    },
]

export const projects = [
    {
        title: "Preliminary Skin Diagnosis",
        summary: "It is a web application that provides an AI-powered solution for classifying skin diseases from uploaded images using a CNN model trained on seven skin conditions with over 85% accuracy. The platform features real-time inference for instant diagnosis, reducing response time to under two seconds and enhancing user engagement. It also includes an intuitive interface for seamless image upload and result display, ensuring accessibility and ease of use across devices.",
        githubLink: "https://github.com/sachinSingh16-09/Preliminary_Skin_Diagnosis",
