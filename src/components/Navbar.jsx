...
import CV from "../assests/Resume_sachin(4).pdf";
...
const Button = styled.button`
  ...
  color: white;
  padding: 10px;
  background: linear-gradient(180deg, #fde50f 26.71%, rgb(252, 31, 241) 99.36%);
